...
import picture from '../../assets/images/banner_head.webp';
...
const PcSalePage = () => {
    ...
    const fetchProductType = async (page, limit) => {
        setPending(true);
        const res = await ProductService.getProductType('PC', page, limit); // Fetch products with type 'PC'
        if (res?.status === 'OK') {
            setPending(false);
